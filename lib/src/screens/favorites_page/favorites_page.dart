  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: ListView.builder(
        ...
        index != imageList.length - 1 ? FavoriteItem(
          title: 'Wow Burger',
          address: 'Arat kilo, Addis Ababa',
          phoneNumber: '+251912365478',
          name: 'Burger, Shawarma',
          images: imageList.sublist(0, index + 1),
          delivery: index != 0 ? true : null,
          outdoor: index != 2 ? true : null,
          openNow: index != 2 ? true : null,
          price: double.parse((index + 1).toString()),
        ) : FavoriteItem(
            title: 'Wow Burger',
            address: 'Arat kilo, Addis Ababa',
            phoneNumber: '+251912365478',
        ...
        child: Padding(
          ...
          child: Column(
              ...
              children: [
                ...
                Text(
                  widget.address, style: TextStyle(fontSize: 15),
                ),
                SizedBox(
                  height: 5,
                ),
                Text(widget.phoneNumber, style: TextStyle(fontSize: 15),),
                SizedBox(
                  height: 5,
                ),
                Row(
                      ...
                      children: [
                        ...
                        if(widget.outdoor != null) Row(
                          children: [SizedBox(width: 5,),
                            ...
                            //   width: 5,
                            // ),
                            Text('Outdoor Seating', style: TextStyle(
                                fontSize: 14, color: Colors.grey[600]),)
                          ],
                        ),
                        if(widget.delivery != null) Row(
                          children: [SizedBox(width: 5,),
                            Icon(
                              Icons.check,
                              color: Colors.green,
